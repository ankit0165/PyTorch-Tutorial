...
for epoch in range(num_epochs):
    ...
    torch.save(model.state_dict(), os.path.join(os.getcwd(), 'dataset','models','cnn_model_weights.pth'))
    print(f'model saved for epoch {epoch+1} ...............')

# Save the model's state dictionary after the training
torch.save(model.state_dict(), os.path.join(os.getcwd(), 'dataset','models','cnn_model_weightsFinal.pth'))
